...
def ingest_faq_data(path):
    if collection_name_faq not in [collection_name for collection_name in chroma_client.list_collections() chromadb.api.client.SharedSystemClient.clear_system_cache()]:
